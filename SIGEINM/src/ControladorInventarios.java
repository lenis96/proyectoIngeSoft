...
Nombre de la clase: ControladorInventarios.java
...
public class ControladorInventarios extends JDialog implements ActionListener,MouseListener{
	...
	void createTable(){
		String [][] datos={{}};
		String [] cabezera={"ID INVENTARIO","ID INMUEBLE","DIRECCION","APROVADO"};
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==mostrarInventariosBoton){
			tabla.setModel(modelo.obtenerInventarios(tipo.equals("S") || tipo.equals("R")));
		}
		else if(e.getSource()==editarInventario){
			setVisible(false);
			new ControladorEspacios(this, idInmueble, modelo,tipo);
			setVisible(true);
		}

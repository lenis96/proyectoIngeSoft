...
public class ControladorInventarioEspacio extends JDialog implements ActionListener {
	...
	public ControladorInventarioEspacio(JDialog parent,ModeloInventarios modelo,int idInmueble,int idInventario,int idEspacio,int instancia,String modo) {
		...
		panel.add(label);
		String[][] informacion=modelo.obtenerInformacionObjetos(modelo.getEspaciosInventarioId(idInmueble, idEspacio, instancia));
		...
		if(modo.equals("E")){
			...
			indicesObjetos=modelo.obtenerIndicesObjetos(modelo.getEspaciosInventarioId(idInmueble, idEspacio, instancia));
			System.out.println("abajo");
